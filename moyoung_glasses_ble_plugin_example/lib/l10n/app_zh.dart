...
class AppZh {
  ...
  static const String dualPluginVerification = '双插件验证';
  static const String enterDualPluginPage = '进入双插件验证页';
  static const String verifyGlassesWatchTogether = '用于同时验证眼镜 + 手表插件是否正常工作';
  ...
  static const String fileSync = '文件同步';
  static const String wifiConnection = 'Wi-Fi连接';
  static const String entered = '已进入';
  static const String notEntered = '未进入';
  static const String connectedSimple = '已连接';
  static const String notConnected = '未连接';
  static const String fileStatistics = '文件统计';
  static const String refreshFiles = '刷新文件';
  static const String downloadFiles = '下载文件';
  static const String image = '图片';
  static const String video = '视频';
  static const String audio = '音频';
  static const String downloadCenter = '下载中心';
  static const String deleteAll = '删除全部';
  static const String localFiles = '本地文件';
  static const String totalDirectorySize = '目录总大小';
  static const String noDownloadedFilesInDirectory = '目录中暂无已下载文件';
  static const String view = '查看';
  static const String downloadProgressWaitingStart = '下载进度：等待开始';
  ...
  static const String noDownloadableFiles = '当前没有可下载文件，请先刷新文件列表';
  static const String connectWifiBeforeDownload = '请先连接设备 Wi-Fi，再下载文件';
  static const String unableToGetDownloadDir = '无法获取下载目录';
  static const String downloadTimeoutRetry = '下载超时，请检查设备连接状态后重试';
  static String downloadCompletedCount(int count) => '下载完成：$count 个文件';
  static String downloadCompletedWithFailure(int success, int fail, String message) =>
      '下载完成：成功 $success，失败 $fail${message.isNotEmpty ? '（$message）' : ''}';
  static String downloadFailedWithError(String error) => '下载失败: $error';
  static const String wifiJoinPrompt = '请查看系统弹窗，点击"加入"连接 Wi-Fi';
  static const String wifiConfigAppliedPrompt = '配置已应用，请点击系统弹窗中的"加入"';
  static const String deviceWifiConnected = '设备 Wi-Fi 连接成功';
  static String deviceWifiConnectFailed(String message) => '设备 Wi-Fi 连接失败: $message';
  static String connectDeviceWifiFailed(String error) => '连接设备 Wi-Fi 失败: $error';
  static const String deviceHasNewFiles = '设备有新文件';
  static const String wifiEnabledWaitingAutoConnect = 'Wi-Fi 已开启，等待文件同步状态后自动连接...';
  static const String loadLocalFilesFailed = '加载本地文件失败';
  static const String localFileNotExistRefreshed = '文件不存在，已刷新列表';
  static const String fileOpenNotSupported = '当前设备不支持直接打开该文件';
  static String openFileFailedWithError(String error) => '打开文件失败: $error';
  static const String deleteFailedEmptyDownloadDir = '删除失败：下载目录为空';
  static const String deleteSkippedDirNotExist = '目录不存在，无需删除';
  static String clearedDownloadDirCount(int count) => '已清空下载目录，共删除 $count 项';
  static String deleteAllFailedWithError(String error) => '删除全部失败: $error';
  static const String confirmDeleteAll = '确认删除全部';
  static const String confirmDeleteAllContent = '确认清空下载目录中的全部文件吗？此操作不可恢复。';
