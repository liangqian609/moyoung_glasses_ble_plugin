...
class AppEn {
  ...
  static const String dualPluginVerification = 'Dual Plugin Verification';
  static const String enterDualPluginPage = 'Open Dual Plugin Test Page';
  static const String verifyGlassesWatchTogether = 'Verify glasses + watch plugins in one page';
  ...
  static const String totalDirectorySize = 'Directory Size';
  static const String noDownloadedFilesInDirectory = 'No downloaded files in this directory';
  static const String view = 'View';
  static const String downloadProgressWaitingStart = 'Download progress: waiting to start';
  ...
  static const String noDownloadableFiles = 'No files to download, please refresh file list first';
  static const String connectWifiBeforeDownload = 'Please connect device Wi-Fi before downloading';
  static const String unableToGetDownloadDir = 'Unable to get download directory';
  static const String downloadTimeoutRetry = 'Download timeout, please check device connection and retry';
  static String downloadCompletedCount(int count) => 'Download complete: $count files';
  static String downloadCompletedWithFailure(int success, int fail, String message) =>
      'Download complete: success $success, failed $fail${message.isNotEmpty ? ' ($message)' : ''}';
  static String downloadFailedWithError(String error) => 'Download failed: $error';
  static const String wifiJoinPrompt = 'Please check system popup and tap "Join" to connect Wi-Fi';
  static const String wifiConfigAppliedPrompt = 'Wi-Fi configuration applied, please tap "Join" in popup';
  static const String deviceWifiConnected = 'Device Wi-Fi connected';
  static String deviceWifiConnectFailed(String message) => 'Device Wi-Fi connection failed: $message';
  static String connectDeviceWifiFailed(String error) => 'Failed to connect device Wi-Fi: $error';
  static const String deviceHasNewFiles = 'Device has new files';
  static const String wifiEnabledWaitingAutoConnect = 'Wi-Fi enabled, waiting for fileSync before auto-connecting...';
  static const String loadLocalFilesFailed = 'Failed to load local files';
  static const String localFileNotExistRefreshed = 'File does not exist, list refreshed';
  static const String fileOpenNotSupported = 'This device cannot open the file directly';
  static String openFileFailedWithError(String error) => 'Failed to open file: $error';
  static const String deleteFailedEmptyDownloadDir = 'Delete failed: download directory is empty';
  static const String deleteSkippedDirNotExist = 'Directory does not exist, nothing to delete';
  static String clearedDownloadDirCount(int count) => 'Download directory cleared, deleted $count items';
  static String deleteAllFailedWithError(String error) => 'Delete all failed: $error';
  static const String confirmDeleteAll = 'Confirm Delete All';
  static const String confirmDeleteAllContent = 'Delete all files in the download directory? This cannot be undone.';
